...
export default async function NosPrestationsPage() {
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden px-4 pb-14 pt-24 sm:pb-16 sm:pt-28 md:pb-20 md:pt-32">
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(214,171,89,0.09)_0%,rgba(214,171,89,0)_36%)]" />
        <div className="relative mx-auto max-w-5xl">
          <div className="mb-7 max-w-4xl space-y-4 sm:mb-10 sm:space-y-5">
            <span className="inline-flex rounded-full border border-primary/20 bg-background/55 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-primary">
              Nos prestations
            </span>
            <h1 className="max-w-4xl text-3xl font-serif font-semibold leading-tight sm:text-5xl sm:font-bold md:text-6xl md:leading-[1.04]">
